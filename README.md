...
|**A native prototype for a crocery store application**| In the course _User Interfaces and Usability_, I implemented a native protototype for a crocery store app. React and Materialize CSS frameworks were utilized to build the necessary components of the prototype. | [Repository](https://github.com/ToniKoskinen/uiu_demo/tree/original) [Demo](https://tonikoskinen.github.io/uiu_demo/) |
